...
premailer --verbose --entities --base-url=http://newsletter-templates.expert-infos.com/templates/$templateName --css=${PWD}/theme/css/style.css ${PWD}/newsletter.html > ${PWD}/newsletter-inline.html
