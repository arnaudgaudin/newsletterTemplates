...
#Désactivation temporaire export en attendant récupération modifs Gilles dans PSD
...
gifsicle -v -O3 --lossy=200 --colors=192 ${PWD}/theme/images/nlcv_aeroport_ORIG.gif -o ${PWD}/theme/images/nlcv_aeroport.gif
